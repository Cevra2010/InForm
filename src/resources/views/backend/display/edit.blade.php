...
@section("content")
    <h1 class="backend-headline flex items-center">
        @livewire("kiosk::display.online-state",['display' => $display]) <span class="ml-2">Bildschirm: {{ $display->name }} (<a href="{{ route("present",$display->hash) }}" target="_blank">Bildschirm öffnen</a>)</span>
    </h1>
    <div class="flex mb-4">
