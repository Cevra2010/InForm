...
@section("content")
    <x-inform-headline title="Neues Konto anlegen" icon="user-plus" />

    @include("layouts.backend.error_success")

    <div class="backend-panel">

        <div class="p-2 text-slate-500 text-sm">
            Legen Sie ein neues Benutzerkonto an. Im darauffolgenden Schritt können Sie dem Benutzer die erforderlichen Berechtigungen zuordnen.
        </div>
